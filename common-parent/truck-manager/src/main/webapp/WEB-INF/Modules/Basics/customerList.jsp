    ...
    <div class="side-navbar-wrapper">
        ...
        <div class="admin-menu">
            ...
            <ul id="side-admin-menu" class="side-menu list-unstyled">
                <li class="active"><a href="${pageContext.request.contextPath}/home/customer.do"> <i class="icon-screen"> </i>客户信息</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-deck">
                            <div class="col-lg-8">
                                <button type="button" class="btn btn-primary" href="${pageContext.request.contextPath}/"><span class="fa fa-plus"></span> 新增</button>
